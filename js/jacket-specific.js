...
<h1>"${jacket.name}"</h1><p class="orange-price">"${jacket.price}"</p><p>"${jacket.description}"</p><p>"${jacket.materials}"</p><p>"${jacket.details}"</p> <label for="sizes">Choose size</label>
...
</select><button class="cta cta-white add-to-cart-button" data-product="${jacket.id}>Add to cart</button></div>`;
  } catch (error) {
