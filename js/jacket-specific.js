...
<h1>${jacket.name}</h1><p class="orange-price">${jacket.price}$</p><p>Description: ${jacket.description}</p><p>Materials: ${jacket.materials}</p><p>Details: ${jacket.details}</p> <label for="sizes">Choose size</label>
